...
<br/>
<div id="signup">
	<form name="regForm" method="post" action="signup_mainproc.jsp">
		<table  class="table table-striped" style="width:60%;" >
			<tr align="center" style="background-color: #dbc3d0">
				<td colspan="2"><b style="color:#5e0231">VinDino - Signup</b></td>
			</tr>
			<tr>
				<!--<th width="16%"><label for="m_email">이메일</label></th>-->
				<td colspan="2" width="57%"  ><input type="text" name="m_email" id="m_email" title="이메일 입력" size="15" maxlength="30" onKeyDown="keyCodeCheckID(event,this);" onClick="jsChkID();"onKeyUp="jsChkID();" onBlur="DuplicateIDCheck(this);"
				placeholder="이메일"/>
				<!--<span onclick="isToLowerCase(document.regForm.m_email,0); DuplicateIDCheck(document.regForm.m_email); return false;" class="btn btn-default">중복확인</span>-->
				<span onclick="DuplicateIDCheck(document.regForm.m_email); return false;" class="btn btn-default">중복확인</span>
				<span id="checkMsgID" class="cr6aa7cc lPad10">이메일을 입력해주세요.</span></td>
		...
		<select name="txBirthday3" class="select lMar10 focusOn" title="태어난 일 선택" style="width:60px;">
			...
			<tr>
				<td colspan="2" align="center">
					<input type="button"
					value="회원가입" id="btnSubmit" class="btn btn-primary"  style="background-color: #5e0231; border:0px;">
